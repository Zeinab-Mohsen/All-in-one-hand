...
public class mowazaf_current_requests {
    ...
    public mowazaf_current_requests() {
    }

    public mowazaf_current_requests(Request request, Zobon zobon, Float zobon_rate, Boolean zobon_is_rated, String zobon_first_name, String zobon_second_name, String zobon_email, String zobon_id, String zobon_phone_numbeer, String request_job, String request_government, String request_date, String request_time, String request_address, String mowazaf_id) {
    ...
    public mowazaf_current_requests(mowazaf_sent_requests mowazaf) {
        request = mowazaf.getRequest();
        zobon=mowazaf.getZobon();
        Zobon_first_name = mowazaf.getZobon().getFirst_Name();
        Zobon_second_name = mowazaf.getZobon().getSecond_Name();
        Zobon_rate = mowazaf.getZobon().getRate();
        Zobon_email = mowazaf.getZobon().getEmail();
        Zobon_id = mowazaf.getZobon().getID();
        Zobon_phone_numbeer = mowazaf.getZobon().getPhone_number();
        Request_job = mowazaf.getRequest().getJob();
        Request_government = mowazaf.getRequest().getGoverment();
        Request_date = mowazaf.getRequest().getDate();
        Request_time = mowazaf.getRequest().getTime();
        Request_address = mowazaf.getRequest().getAddress();
    }
