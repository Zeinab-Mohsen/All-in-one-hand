...
public class mowazaf_sent_requests {
    ...
    public mowazaf_sent_requests() {
    }

    public mowazaf_sent_requests(Request request, Zobon zobon, Float zobon_rate, Boolean zobon_is_rated, String zobon_first_name, String zobon_second_name, String zobon_email, String zobon_id, String zobon_phone_numbeer, String request_job, String request_government, String request_date, String request_time, String request_address) {
